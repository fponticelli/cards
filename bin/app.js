...
Main.main = function() {
	thx.stream.dom.Dom.ready().success(function(_) {
		...
		haxe.Log.trace("START HERE",{ fileName : "Main.hx", lineNumber : 8, className : "Main", methodName : "main"});
	});
};
Math.__name__ = true;
var Std = function() { };
