...
Dom.ready((function() {
  var $card = Query.first('.card'),
      ...
      $side = Query.first('.side', $card),
      $context = Query.first('.context', $side),
      $context_header = Query.first('header', $context),
      $context_article = Query.first('article', $context),
      $model = Query.first('.model', $side),
